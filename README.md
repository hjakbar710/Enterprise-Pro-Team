...
The project involves developing a web interface that allows users to interact with spatial asset datasets, including user authentication, dataset upload, and data visualisation.
...
Software – Source code for the P2 project
